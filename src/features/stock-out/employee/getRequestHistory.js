...
const StockoutPage = () => {
  ...
  const fetchStockoutData = async () => {
    try {
      ...
      const response = await axios.get('https://apartment.houseethiopia.com/api/stockout/for-requester', 
          {
              headers: {
  ...
  const handleCancelRequest = async (id) => {
    try {
      ...
      const response = await axios.put(`https://apartment.houseethiopia.com/api/stockout/cance-request/${id}`, {}, {
        headers: {
          Authorization: `Bearer ${token}`,
        }
      });
  ...
  const handleUpdateRequest = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`https://apartment.houseethiopia.com/api/stockout/${editItem.id}`, payload, {
        headers: {
          Authorization: `Bearer ${token}`,
        }
      });
